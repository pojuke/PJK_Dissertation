...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=11cm]{Chapter5/3YrNMDS_Species_Common.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=12cm]{Chapter5/FourQuadrateMovement_Species_Common_RevisedMS.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=15cm]{Chapter5/BetaDiversity_CompiledFull2015_Common_RevisedMS.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=15cm]{Chapter5/Goodness_FungiSpecies_CombinedIndividual_Full2015glmmTMBTotal_Revised2MS.pdf}}
...
\begin{figure}[h]
	\vspace*{-1cm}
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=6.5cm]{Chapter5/Funguild_HMSC_FungiSpecies_CombinedIndividual_Full2015Total_PathogenLong.pdf}}
