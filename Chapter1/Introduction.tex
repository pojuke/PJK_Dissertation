...
Despite our growing knowledge on the successional dynamics of soil microbes, how their effects on plants vary with conditioning time remains rarely studied \citep{Kardol2013, Lepinay2018}. This is presumably because preparing soils with different conditioning lengths is often not feasible in the greenhouse \citep{Kardol2013, Kulmatiski2018}, and the length of soil conditioning in the field can only be quantified with coarse resolution (e.g., \citealp{Day2015, Speek2015}). 
...
% Overall, species interactions and competitive outcomes depend on three different temporal dimensions. First, the order of species arrival (i.e., priority effect; Chapter 3). Second, how fast do species affect their environment (i.e., the impact niche; Chapter 2). Third, how species' responses to the environment vary throughout their ontogeny (i.e., the requirement niche; Chapter 2). 
% However, the complexity of species interactions challenges these assumptions: organisms vary greatly in their impact on the focal community, ranging from antagonism to mutualism, and in their dynamical rates, ranging from fast to slow compared to the focal community. To move forward, ecologists need to develop a general framework to study how interaction types and species’ dynamical rates interactively affect the importance of multi-trophic interactions in regulating species diversity
\par
