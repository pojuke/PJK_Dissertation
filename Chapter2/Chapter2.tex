...
\textbf{Box 2.1}
\end{flushleft}
\begin{infobox}[Deriving niche overlap and fitness differences in terms of consumer-resource parameters]
...
\begin{flushleft}
	\textbf{Box 2.2}
\end{flushleft}
\begin{infobox}[Empirical tests of consumer-resource competition through the lens of modern coexistence theory]
