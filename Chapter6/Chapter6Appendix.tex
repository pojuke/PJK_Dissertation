...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=15cm]{Chapter6/Composition_Both_Species.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=15cm]{Chapter6/Richness_Fungi_Summary.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=15cm]{Chapter6/Richness_Bacteria_Summary.pdf}}
...
\begin{figure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=14cm]{Chapter6/Composition_Bacteria_Age.pdf}}
...
\begin{sidewaysfigure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=20cm]{Chapter6/HMSC_Fungi_Family_Summary.pdf}}
...
\begin{sidewaysfigure}[h]
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=20cm]{Chapter6/HMSC_Bacteria_Family_Summary.pdf}}
...
\begin{sidewaysfigure}[h]
	\centering
	\makebox[18cm][c]{\includegraphics[width=20cm]{Chapter6/Simulation_AllPSF_Aggregate.pdf}}
